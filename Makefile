...
SOURCES       = main.cpp \
		...
		canvas.cpp \
		workerthread.cpp \
		crossfield3d.cpp qrc_resources.cpp \
		moc_mainwindow.cpp \
		moc_glwidget.cpp
OBJECTS       = main.o \
		distancetransform.o \
