...
# Template: app
# Command: /usr/local/Cellar/qt/5.10.1/bin/qmake -o Makefile BendFields_OSX.pro -spec macx-clang CONFIG+=debug CONFIG+=x86_64
#############################################################################
...
Makefile: BendFields_OSX.pro /usr/local/Cellar/qt/5.10.1/mkspecs/macx-clang/qmake.conf /usr/local/Cellar/qt/5.10.1/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile BendFields_OSX.pro -spec macx-clang CONFIG+=debug CONFIG+=x86_64
